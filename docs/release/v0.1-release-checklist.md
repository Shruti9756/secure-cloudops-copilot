...
- [x] Fresh-clone verification passed: Docker Compose rebuild, migrations, demo ingestion, 153 standard tests, 1 live E2E test, frontend audit, lint, and production build.
